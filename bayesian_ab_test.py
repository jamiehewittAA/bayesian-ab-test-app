...
if show_decision_mode:
    ...
    ax3.axvline(max_ci_width_pct, color='red', linestyle='--', label='Selected CI Width')
    idx = np.argmin(np.abs(widths - max_ci_width_pct))
    ax3.scatter([max_ci_width_pct], [days[idx]], color='red', s=100, label='Days Still Needed')
